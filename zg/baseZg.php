...
if(!defined("ZG_ROOT"))
{
    ...
    defined("ZG_VERSION") || define("ZG_VERSION","2.1.5");
    ...
    if(RUNNING_ENV == "PRODUCTION")
    {
		...
		# suppresses errors generated by migreated from PHP 5.3 to 5.5
...
defined("ZG_TEMPLE_ROOT") ||  define("ZG_TEMPLE_ROOT", \zinux\kernel\utilities\fileSystem::resolve_path(ZG_ROOT."/zg/resources/templates"));
/**
 * baseZg class
